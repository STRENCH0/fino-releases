...
### Изменено
- URL сервера курсов валют

## [6.5.1] - 2026-05-02

### Исправлено
- Жест назад после вызова диалогов шаблонов

## [6.5.0] - 2026-04-30

### Добавлено
- Шаблоны транзакций (частые операции): сохранение транзакций как шаблонов для быстрого повторного использования
- Автоопределение частых операций на основе пар категорий и сумм
- Экран управления шаблонами (доступен из вкладки "Другое" или нижней панели навигации)
- Кнопка "Сохранить как шаблон" в деталях транзакции

## [6.4.3] - 2026-02-12

### Исправлено
- Исправлено открытия калькулятора на операции перевода
